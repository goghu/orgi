...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { borrado: @categorium.borrado, descripcion: @categorium.descripcion, icon_id: @categorium.icon_id, movimiento: @categorium.movimiento, nombre: @categorium.nombre, tipo: @categorium.tipo, user_id: @categorium.user_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { borrado: @categorium.borrado, descripcion: @categorium.descripcion, icon_id: @categorium.icon_id, movimiento: @categorium.movimiento, nombre: @categorium.nombre, tipo: @categorium.tipo, user_id: @categorium.user_id } }
